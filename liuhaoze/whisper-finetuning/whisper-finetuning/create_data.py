...
def main():
    ...
    print(f"DEBUG: args.with_timestamps = {args.with_timestamps}")
    print(f"DEBUG: args.data_file = {args.data_file}")

    # Workaround: Force with_timestamps to False if data_file is provided
    if args.data_file: # if data_file is provided, it implies without-timestamps mode
        args.with_timestamps = False
        print(f"DEBUG: Forcing args.with_timestamps to False because data_file is provided.")
