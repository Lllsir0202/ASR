...
class SpecAugment():
    ...
    def time_warp(self):
        ...
        self.mel_spectrogram = np.reshape(self.mel_spectrogram,
                                          (-1, self.mel_spectrogram.shape[0], self.mel_spectrogram.shape[1], 1))
        ...
        random_pt = horiz_line_thru_ctr[
            random.randrange(self.W, tau - self.W)]  # random point along the horizontal/time axis
        ...
        self.mel_spectrogram, _ = sparse_image_warp(self.mel_spectrogram, src_points, dest_points,
